...
public class TrackTimeAspect {
    ...
    @Pointcut("execution(@ru.t1.aophome.annotation.TrackTime public * *(..))")
    ...
    public Object around(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        Object result;
        try {
            log.info("Выполнение синхронного метода {} с аргументами {}", methodName, proceedingJoinPoint.getArgs());
